...
# Props Batch 3 Sprite Sheet Batch 1
...
Canonical bounds:
Use the prop-specific dimensions and grip anchors from the JSON/module prompt

Canonical pivot:
Use each prop's named grip or placement anchor

VARIANT ORDER

Cell 1: Beanbag Empty
Cell 2: Beanbag Occupied Depression
Cell 3: Blanket Over Legs
Cell 4: Blanket Sleeping
Cell 5: Phone Raised To Ear
Cell 6: Laptop Open 3/4
Cell 7: Controller Raised
Cell 8: Coffee Cup Resting
