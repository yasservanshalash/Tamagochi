...
Canonical bounds:
Use a consistent effect-safe area within each 320×320 cell

Canonical pivot:
Use the effect origin or attachment point defined by the model output

VARIANT ORDER

Cell 1: Speech Bubble Small
Cell 2: Speech Bubble Medium
Cell 3: Thought Bubble Small
Cell 4: Thought Bubble Medium
Cell 5: Question Mark
Cell 6: Exclamation Mark
Cell 7: Question + Exclamation
Cell 8: Ellipsis
